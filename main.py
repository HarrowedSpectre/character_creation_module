...
def attack(char_name: str, char_class: str) -> str:
    """Расчёт и вывод урона от атаки каждого игрового класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Расчет и вывод заблокированного урона для каждого игрового класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Расчет и вывод урона от специального приема каждого игрового класса."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Выбираем игровой класс и начинаем тренировку."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Ввод имени персонажа и выбор игрового класса."""
    approve_choice: str = ''
    char_class: str = ''
